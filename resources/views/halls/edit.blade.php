...
@section('title') @lang('main.edit_hall') @endsection

@section('content')
  @include('include.block-header.min', ['data' => ['sub' => trans('main.edit_hall'), 'title' => $hall->name]])

  <form action="{{ route('halls.update', $hall->id) }}" class="form-contact needs-validation" method="POST" novalidate>
    @csrf
    @method('patch')
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="form-control-wrap">
                  <input type="text" id="name-{{ $localeCode }}" name="name[{{ $localeCode }}]" value="{{ $hall->getTranslation('name', $localeCode) }}"
