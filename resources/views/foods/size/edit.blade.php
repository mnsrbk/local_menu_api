            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="form-control-wrap">
                  <input type="text" id="name-{{ $localeCode }}" name="name[{{ $localeCode }}]" value="{{ $size->getTranslation('name', $localeCode) }}"
    ...
    <div class="form-group">
      ...
      <div class="form-control-wrap">
        <input type="number" id="price" name="price" class="form-control form-control-lg @error('price') is-invalid @enderror" placeholder="@lang('main.price')"
               value="{{ price_format($size->price) }}" min="1"  step="0.01" required>
        @if ($errors->has('price'))
